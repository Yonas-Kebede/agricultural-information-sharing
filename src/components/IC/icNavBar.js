      ...
      <div className="container">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto" >
            ...
            <Paper elevation={0} sx={{marginLeft:'3rem' ,backgroundColor:'whitesmoke',display:{xs:'block',md:'flex'}}}>
            

            <Nav.Link  as={Link} to="/Newsfeed" className="nav-link navLink1">
              <h6>Newsfeeds</h6>
            </Nav.Link>
            <Nav.Link as={Link} to="/Imkt" className="nav-link navLink1">
              market-information
            </Nav.Link>
{/*             
            ...
            <Nav.Link as={Link} to="/messages" className="nav-link NavLink1">
              Message
            </Nav.Link>
